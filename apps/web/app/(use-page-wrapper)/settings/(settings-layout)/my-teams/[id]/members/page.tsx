...
const getCachedTeamRoles: typeof fetchTeamRoles = unstable_cache(fetchTeamRoles, undefined, {
  revalidate: 3600,
  tags: ["pbac.team.roles.list"],
});

const fetchTeamAttributes = async (
  organizationId?: number
): Promise<Awaited<ReturnType<PrismaAttributeRepository["findAllByOrgIdWithOptions"]>> | []> => {
...
const getCachedTeamAttributes: typeof fetchTeamAttributes = unstable_cache(fetchTeamAttributes, undefined, {
  revalidate: 3600,
